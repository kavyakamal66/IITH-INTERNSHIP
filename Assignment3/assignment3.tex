...
Given intercepts are $\myvec{a\\0}$ and $\myvec{0\\b}$  and 
$\vec{u}$ be $\myvec{p\\q}$\\
\begin{figure}[!h]
         \centering
         ...
         \label{Figure}
\end{figure}\\
Substituting $\myvec{a\\0}$ in \ref{eq:2}

\begin{equation}
    \myvec{a\ 0}\myvec{a\\0}+2\vec{u^\top}\myvec{a\\0}=0
\end{equation}

\begin{equation}
\implies a^2+2\myvec{p \ q}\myvec{a\\0}=0
\end{equation}

\begin{equation}
    \implies \myvec{p \ q}\myvec{a\\0}=-a^2/2
\end{equation}
...
Substituting $\myvec{0\\b}$ in \ref{eq:2}
\\
\begin{equation}
    \myvec{0\ b}\myvec{0\\b}+2\vec{u^\top}\myvec{0\\b}=0
\end{equation}

\begin{equation}
\implies b^2+2\myvec{p \ q}\myvec{0\\b}=0
\end{equation}

\begin{equation}
    \implies \myvec{p \ q}\myvec{0\\b}=-b^2/2
\end{equation}
...
\begin{equation}
    \vec{O}= \myvec{a/2 \ b/2}
\end{equation}
Let x-intercept be $\myvec{6\\0}$, y-intercept be $\myvec{0\\8}$
The radius of the circle can be found out using
\begin{equation}
    r^2= \vec{u^\top}\vec{u}
\end{equation}
where $\vec{u}= \myvec{-a/2 \ -b/2}$
\begin{equation}
...
\end{equation}
\begin{equation}
    \vec{x^\top}\vec{x}-\myvec{a \ b }\vec{x}=0
\end{equation}
